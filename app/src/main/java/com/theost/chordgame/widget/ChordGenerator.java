package com.theost.chordgame.widget;
...
import com.theost.chordgame.widget.utils.ChordUtils;
import com.theost.chordgame.widget.utils.ResUtils;
...
public class ChordGenerator {
    ...
    private void generateStringChord(String[] chordData, int instrument) {
        ...
        for (String request : Objects.requireNonNull(chordRequest.get(chordFrets.get(0)))) {
